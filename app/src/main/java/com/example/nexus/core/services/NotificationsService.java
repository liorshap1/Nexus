...
public class NotificationsService extends Service {
  ...
  public class NotificationsServiceBinder extends Binder {
    public NotificationsService getService() { return NotificationsService.this; }
  }
  ...
  private void createNotificationChannel() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      ...
      NotificationChannel notificationChannel =
          new NotificationChannel("chat_channel_id", channelTitle, channelImportance);
  ...
  private void createNotification(Message message) {
    // Untested
    var sensitizedUserJson =
        SharedPreferencesUtils.getDataByKey(
            getApplicationContext(), "user_" + message.getMessageDeliverUid());
    User user = gson.fromJson(sensitizedUserJson, User.class);

    NotificationCompat.Builder builder =
        new NotificationCompat.Builder(this, "chat_channel_id")
  ...
  private void startServiceListener(String chatId) {
    ...
    messagesRef = FirebaseDatabase.getInstance()
            .getReference(Constants.FIREBASE_DATABASE.CHATS)
            .child(chatId)
